...
public class UserSServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/views/user/student.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (add > 0) {
            response.sendRedirect(request.getContextPath() + "/user/student?msg=OK");
            return;
        } else {
            response.sendRedirect(request.getContextPath() + "/user/student?msg=ERROR");
            return;
        }
    }
