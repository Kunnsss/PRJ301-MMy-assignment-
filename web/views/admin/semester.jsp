            ...
            <table class="table table-bordered" id="datatable">
                ...
                <tbody>
                    ...
                    <tr class="tr-hover">
                        ...
                        <td><%=objSemester.getSemesterID() %></td>
                        <td><%=objSemester.getSemesterName() %></td>
                        <td>
                            <button type="button" class="btn btn-danger suaMenu" ">
                                <a href="#" onclick="confirmAndDelete('<%=request.getContextPath()%>/admin/delete?semester=<%= objSemester.getSemesterID() %>')">Delete</a>
                            </button>
                ...
                <div class="modal-body">
                    <form action ="<%=request.getContextPath()%>/admin/semester" method="post">
                        <div class="form-group row">
                            <label for="exampleFormControlFile1" class="col-sm-3">Semester ID</label>
                            <input type="text" class="form-control-file col-sm-8" id="exampleFormControlFile1" name="semesterID">
                        </div>
                        <div class="form-group row">
                            <label for="exampleFormControlFile1" class="col-sm-3">Semester Name</label>
